...
class Tools(info: ProjectInfo) extends DefaultProject(info) {
  ...
  protected override def copyResourcesAction = copyTask(mainResources,
      mainResourcesOutputPath) describedAs CopyResourcesDescription 
  protected override def copyTestResourcesAction = 
  copyTask(testResources, testResourcesOutputPath) describedAs 
